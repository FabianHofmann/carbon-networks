...
\begin{frame}
    ...
    \includegraphics[width=\linewidth]{operation_map_carbon_co2network_200.png}
\end{frame}

\begin{frame}
    \textbf{Carbon Capture (left) and Utilization \& Storage (right) for 400~Mt$_{\text{seq}}$/a}
    \includegraphics[width=\linewidth]{operation_map_carbon_co2network_400.png}
\end{frame}

\begin{frame}
    \textbf{Carbon Capture (left) and Utilization \& Storage (right) for 600~Mt$_{\text{seq}}$/a}
    \includegraphics[width=\linewidth]{operation_map_carbon_co2network_600.png}
\end{frame}

\begin{frame}
    \textbf{Carbon Capture (left) and Utilization \& Storage (right) for 800~Mt$_{\text{seq}}$/a}
    \includegraphics[width=\linewidth]{operation_map_carbon_co2network_800.png}
\end{frame}
