...
% in system costs: 779bn€ (baseline), 754bn€ (carbon), 742bn€ (hydrogen), 738bn€ (hybrid)
...
In this combination, the networks enable full carbon capture upgrades for all technologies that run on a high average capacity factor (above 70\%, see Fig.~\ref{fig:captureshare_line}). Except for SMR and gas-fired Combined Heat and Power Plants (CHP) which operate a few weeks annually, all emissions from carbon-emitting technologies are captured.
...
The carbon prices are relatively evenly distributed across the continent at high level 115-155~€/t. This indicates
