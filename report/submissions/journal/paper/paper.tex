...
\begin{itemize}
    ...
    \item[] \textit{\hydrogen{}~Grid:} Only the \hydrogen{} network is developed.
    \item[] \textit{\carbon{}~Grid:} Only the \carbon{} network is developed.
...
Focusing first on the NZ scenarios, we can highlight significant variations in system costs and technology deployment depending on the network strategy employed (see Figure~\ref{fig:cost_bar}).
