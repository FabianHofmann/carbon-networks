...
% CU also has an incentive to co-locate in Central Europe with district heating demand, which can use the waste heat from the Fischer-Tropsch process.
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.5\linewidth]{comparison/updated-electrolisys-capex-co2-only/figures/90_nodes/cost_bar.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.5\linewidth]{comparison/updated-electrolisys-capex-h2-only/figures/90_nodes/cost_bar.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.5\linewidth]{comparison/updated-electrolisys-capex-full/figures/90_nodes/cost_bar.png}
