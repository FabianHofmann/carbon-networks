...
\begin{figure*}[ht!]
    ...
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{co2-only/figures/90_nodes/operation_map_single_carbon.png}
        \caption{\carbon{} Sector in \carbongrid{} model.}
        \label{fig:co2-only-operation_map_carbon}
    \end{subfigure}
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{co2-only/figures/90_nodes/operation_map_single_hydrogen.png}
        \caption{\hydrogen{} Sector in \carbongrid{} model.}
        \label{fig:co2-only-operation_map_hydrogen}
    \end{subfigure}
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{h2-only/figures/90_nodes/operation_map_single_carbon.png}
        \caption{\hydrogen{} Sector in \hydrogengrid{} model.}
        \label{fig:h2-only-operation_map_carbon}
    \end{subfigure}
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{h2-only/figures/90_nodes/operation_map_single_hydrogen.png}
        \caption{\hydrogen{} Sector in \hydrogengrid{} model.}
