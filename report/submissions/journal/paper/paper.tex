...
Hydrogen can be gained from electrolysis and steam methane reforming (SMR). Salt caverns for \hydrogen{} storage are derived from~\cite{caglayanTechnicalPotentialSalt2020}.

\dots

% carbon capture technologies
Carbon capture technologies are represented by a set of augmented technologies with integrated carbon capture. These include Allam Cycle, Gas CHP, SMR, DAC, biomass, biogas and capture of process emissions from industry.
