...
% The creation of a \Htwo{} network enables the cost-effective delivery of hydrogen from regions with a surplus of low-cost renewable energy to high-demand industrial centers with exogenous hydrogen demand and a surplus of low-cost CC potentials, reducing the need for DAC and for high-cost electrolysis at the industrial centers.
% This highlights how both the implementation of a \COtwo{} or a \Htwo{} network unlocks low-cost carbon capture potentials at geographically fixed point sources across the continent.
