...
=======
% This section is much too long. It should only be descriptive with respect, not interpretive, what do we see in the graph? what are the biggest contributions and differences? it only introduces and doesn\t answer why.
...
% similar changes in both models:
% - DAC at coast in combination with sequestration and heat supply from additional heat pumps and power supply from additional renewable in the vicinity
% - less gas boilers import from LNG terminals, more heat supply from heat pumps (Gas effect)
% - additional distributed power installation across all countries enable more distributed electrolysis and compensate for the loss of gas boilers which are replaced by heat pumps
% - more biogas and biogas to gas in central and eastern europe with additional co2 capture to compensate for less fossil gas imports (Gas effect)

% -> main slacks to remove carbon from the atmosphere: DAC together with additional power and heat supply
% -> replace fossil gas based heating with heat pumps and biogas to gas with additional carbon capture
