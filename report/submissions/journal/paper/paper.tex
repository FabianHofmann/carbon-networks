...
% TODO: integrate definition of Carbon Management (CM) into last sentence.
% Cx: CU, CS, CT, CC, Cstorage --> CO2 + H2 networks are crucial to carry out CM strategies
% Suggestion:

% TODO: check definition of carbonaceous fuels for "missing" (relevant) fuel types

% TODO: boil this down to one sentences and integrate it to the previous paragraph or move it two the literature part.
% Suggestion: We argue that it is crucial to consider CC, CU and CS as separate technologies, rather than grouping them under the often-used but misleading umbrella term "CCUS", to allow for more accurate optimization and analysis of each function in the carbon management system.
% Suggestion: We argue that it is crucial to consider CC, CU and CS as separate technologies, rather than grouping them under the often-used but misleading umbrella term ``carbon capture, utilization and storage'' (CCUS), to allow for independent optimization and adequate representation of each function in the carbon management system.
...
% TODO: mention policy ambition for carbon and hydrogen strategies separately in two sentences.
...
% TODO: rather cite europeancommissionEuropeanCO2Storage
...
% TODO: optionally find better place for this
...
% TODO: explain why misalignment takes place -> exogenous factors renewable potentials, industrial clusters with h2 demand, co2 point sources, sequestration sites,
...
Total annual system costs in the \modBase{} are highest, totalling \label{}779 billion euros. The models with additional transport options for carbon and hydrogen achieve a more efficient system allocation and lower total system costs, with \label{}3.1\% cost reduction (\label{}754~bn€) in the \modCO{}, and \label{}4.8\% (\label{}741~bn€) in the \modH{}, and \label{}5.2\% (\label{}738~bn€) in the the \modHybrid{}.
