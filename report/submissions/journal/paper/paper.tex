...
The Hybrid scenario represents the most integrated network strategy, combining both CO2 and H2 networks. While the cost-reduction compared to the \hydrogen-Net scenario is marginal, the allocation of costs reveals a propagation of cost savings in DAC facilities.
...
While the share of CC share for the combustion of upgraded biogas (100\%) and Gas in CHP (0\%) remains unchanged across all scenarios, the
