...
\newcommand{\baseline}{../results/baseline/figures/40_nodes/}
\newcommand{\halfprice}{../results/half-price/figures/40_nodes/}
\newcommand{\projectedprice}{../results/projected-price/figures/40_nodes/}
\newcommand{\comparison}{../results/comparison/figures/40_nodes/}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{\baseline sequestration_map.png}
...
\begin{figure*}[ht!]
    \centering
    \includegraphics*[width=\linewidth]{\comparison cost_area.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{\comparison operation_area_carbon.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{\comparison operation_area_hydrogen.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{\comparison operation_area_co2.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{\comparison captureshare_line.pdf}
...
\begin{figure*}[ht!]
    \centering
    \includegraphics[width=\linewidth]{\projectedprice balance_map_carbon.png}
...
A dataset of the model results is available at \href{zenodo}{doi:zenodo}.
...
\label{sec:supplementary-information}
